...
<form class="formoid-solid-green" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"><div class="title"><h2>My form</h2></div>
	...
	<div class="element-radio<?php frmd_add_class("radio"); ?>"><label class="title">Radio Buttons<span class="required">*</span></label>		<div class="column column2"><label><input type="radio" name="radio" value="option 1" required="required"/><span>option 1</span></label></div><span class="clearfix"></span>
	...
	<div class="element-date<?php frmd_add_class("date1"); ?>"><label class="title"></label><div class="item-cont"><input class="large" data-format="yyyy-mm-dd" type="date" name="date1" placeholder="Date"/><span class="icon-place"></span></div></div>
