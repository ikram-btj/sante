...
<script type="text/javascript" src="css/formoid_files/formoid1/jquery.min.js"></script>
  ...
  <center>
<h2>Les antecedants</h2>

  <p>les antecedants personnels et Familiaux:</p>            
  <table class="table table-hover"style="width:900px;">
    <thead>
      <tr>
        <th><b>type_antecedent:</b></th>
...
//while ($champ = mysql_fetch_object($ligne) )
 ...
 $bd = mysql_query('SELECT  * FROM antecedant where id_p = '.$id_p.'  ') ;
