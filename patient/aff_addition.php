  ...
  <aside class="main-sidebar">
    ...
    width:50px;" class="img-circle" alt="User Image">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            </i> <span>Antecedents</span> 
          </a>
          <ul class="treeview-menu">
            
            <li><a href="aff_antecedent_f.php" ><i class="fa fa-circle-o"></i> Antecedents familiaux</a></li>
			  <li><a href="aff_antecedent_p.php"><i class="fa fa-circle-o"></i> Antecedents personnel</a></li>
			<li><a href="rech_maladie.php"><i class="fa fa-circle-o"></i> Rechercher d'un maladie</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
			 ...
			 <li><a href="aff_vaccin.php"><i class="fa fa-circle-o"></i> Lister</a></li>
            <li><a href="rech_vaccin.php"><i class="fa fa-circle-o"></i> Rechercher</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class=" active  treeview-menu">
            ...
            <li><a href="aff_addition.php" class="active"><i class="fa fa-circle-o"></i> Afficher</a></li>
...
$sql="select * from addition where id_p='$id_p'";
$table=mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error()); 
if($ligne=mysql_fetch_array($table)){?>




<br><label class="LabelOne" > Fumez-vous?:
<?php echo $ligne['tabac'];?></label>
<br><label class="LabelOne" >A quel age vous commencé à fumer? :
<?php echo $ligne['age_comance_fum'];?></label>
<br><label class="LabelOne" >Combien de cigarettes fumez-vous par jour? :
<?php echo $ligne['nbr_cigr'];?></label>
<br><label class="LabelOne" >Avez-vous deja essaye d'arreter? :
<?php echo $ligne['arreter'];?></label>
<br><br>
<label>Consomation de boissons a alcoolisées:</label>

<br><label class="LabelOne" >Combien de fois? :
<?php echo $ligne['fois_arreter'];?></label>

<br><label class="LabelOne" >À quelle fréquence consommez-vous des boissons alcoolisées? :
<?php echo $ligne['frq_alco'];?></label>
