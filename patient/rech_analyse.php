...
<td>
<p class="Style123" ><h2>Rechercher de analyse(s)</h2>
<img src="mes_img/anl.png" width="300" height="300" />
</p></center> 

<form method="post" action="rech_analyse.php" class="margin-left:200px;">
<span class="Style18">
<u>Chercher par :</u>
</span>
  <select name="type">
  
    <option value="	nom_analyse">nom_analyse</option>
...
$type = addslashes ($_POST['type']);
	if ($type="nom_analyse")
	{
	$retour = mysql_query("SELECT * FROM analyse WHERE nom_analyse='$valeur' ORDER BY id_analyse ASC");
	
	}
	elseif ($type="id_analyse")
	{
	$retour = mysql_query("SELECT * FROM analyse WHERE id_analyse='" . $_POST['id_analyse'] . "' ORDER BY id_analyse ASC");
	}
?>
<p><center>
...
?>
  <tr>
    ...
    <td><?php echo stripslashes($donnees['id_analyse']); ?></td>
    <td><?php echo stripslashes($donnees['nom_analyse']); ?></td>
    <td><?php echo stripslashes($donnees['date_resultat_analyse']); ?></td>
  </tr>
  <?php
