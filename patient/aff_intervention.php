      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
			...
			<li><a href="rech_hospitali.php"><i class="fa fa-circle-o"></i> Rechercher</a></li>
          </ul>
        </li>
...
<h2>Les interventions:</h2>
  ...
  <table class="table table-hover" style ="margin-left:200px;width:850px;">
    <thead>
      <tr>
        <th><b>Date d'intervention:</b></th>
		<th><b>L'organe(e) concernet(e):</b></th>
        <th><b>Motif d'intervention:</b></th>
		<th><b>Type anesthésie:</b></th>
        <th>Raport medical:</th>
...
$id_p = $_SESSION['login_p'];
 ...
 $bd = mysql_query('SELECT  * FROM intervention where id_p = '.$id_p.'  ') ;
while($base = mysql_fetch_object($bd)){
 echo "
      ...
      <tr>
        <td>$base->date_intr</td>
		<td>$base->partie_corps</td>
        <td>$base->motif_intr</td>
		<td>$base->typ_anst</td>
        <td>$base->commantaire_intr</td>
