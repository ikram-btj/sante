...
<td>
<p class="Style123" ><h2>Rechercher de radio(s)</h2>
<img src="mes_img/exm.jpg" width="300" height="300" />
</p></center> 

<form method="post" action="rech_radio.php" class="margin-left:200px;">
<span class="Style18">
<u>Chercher par :</u>
</span>
  
    <select name="type">
	<option value="id_radio">id_radio</option>
    <option value="type_rad">type_rad</option>
...
$type = addslashes ($_POST['type']);
	if ($type="type_rad")
	{
	$retour = mysql_query("SELECT * FROM radio WHERE type_rad='$valeur' ORDER BY id_radio ASC");
	
	}
	elseif ($type="id_radio")
	{
	$retour = mysql_query("SELECT * FROM radio WHERE id_radio='$valeur' ORDER BY id_radio ASC");
	}
?>
<p><center>
...
?>
  <tr>
    ...
    <td><?php echo stripslashes($donnees['id_radio']); ?></td>
    <td><?php echo stripslashes($donnees['type_rad']); ?></td>
	<td><?php echo stripslashes($donnees['partie_corps']); ?></td>
	<td><?php echo stripslashes($donnees['motif_radio']); ?></td>
  </tr>
  <?php
