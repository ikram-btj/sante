...
<header class="main-header">
    ...
    <a href="index2.html" class="logo" style="height: 60px;">
      ...
      <span class="logo-lg"><b>Pati</b>ent</span>
    </a>
    ...
    width: 35px;"class="img-circle" alt="User Image"> </div>
              ...
              <span class="hidden-xs" class="label label-success">  Antecedents</span>
            </a>
			   <ul class="dropdown-menu">
             <!-- <li class="header">You have 4 messages</li>
			 -->
    ...
    <section style="height: auto;" class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <a href="../acc_medecin.php"> <img src="mes_img/mede.jpg" style="
    height: 50px;
    width:50px;" class="img-circle" alt="User Image">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="#">
            </i> <span>Consultation</span> 
          </a>
          <ul class="treeview-menu">
            <li><a href="aff_cons.php"><i class="fa fa-circle-o"></i> Lister</a></li>
			<li><a href="rech_cons.php"><i class="fa fa-circle-o"></i> Rechercher</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
			 <li><a href="afficher analyse.php"><i class="fa fa-circle-o"></i> Lister</a></li>
            <li><a href="rech_analyse.php"><i class="fa fa-circle-o"></i> Rechercher</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="aff_radio.php"><i class="fa fa-circle-o"></i> Lister</a></li>
            <li><a href="rech_radio.php"><i class="fa fa-circle-o"></i> Rechercher</a></li>
          </ul>
        </li>
...
<script type="text/javascript" src="css/formoid_files/formoid1/jquery.min.js"></script>
  ...
  <center>
<h2>Les Analyses: </h2>
    <!-- <a data-toggle="tab" href="#menu4"> <button type="button" class="btn btn-primary"style="width:250px;">image</button></a>
  ...
  <table style ="margin-left:200px;width:850px;" class="table table-hover" >
    <thead>
      <tr>
        <th ><b>type_analyse:</b></th>
		<th ><b>nom_analyse:</b></th>
...
$id_p = $_SESSION['login_p'];
 ...
 //id_analyse in (SELECT id_analyse FROM analyse,consultation2  WHERE consultation2.id_cons2=analyse.id_cons2 and id_p= '3')") ;
while($base = mysql_fetch_object($bd)){
 echo "

      <tr>
        <td>$base->type_analyse</td>
		<td>$base->nom_analyse</td>
        <td>$base->date_resultat_analyse</td>
        <td>
		
		<button type='button' class='btn btn-info btn-lg' id='myBtn'>$base->image_analyse</button>
    ...
    <div class='modal-dialog'>
      ...
      <div class='modal-content'>
        ...
        <div class='modal-body'>
		  ...
		  <img src='imgvac/$base->image_analyse' alt='sante'width='200'height='150'>
        </div>
