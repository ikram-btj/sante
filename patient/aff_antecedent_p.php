...
<script type="text/javascript" src="css/formoid_files/formoid1/jquery.min.js"></script>
  ...
  <center>
<h2>Antécédents Personnel</h2>
         
  <table class="table table-hover" style ="margin-left:200px;width:850px;">
    <thead>
      <tr>
        
		<th><b>type_maladie:</b></th>
        <th><b>nom_maladie:</b></th>
		<th><b>date_maladie:</b></th>
        <th>remarque_antecedent:</th>
...
//while ($champ = mysql_fetch_object($ligne) )
 ...
 $bd = mysql_query("SELECT  type_maladie,nom_maladie,date_maladie,remarque_antecedent FROM antecedant where id_p='$id_p' and type_antecedent='personnel'  ") ;
while($base = mysql_fetch_object($bd)){
 echo "
      ...
      <tr>
		...
		<td>$base->type_maladie</td>
        <td>$base->nom_maladie</td>
		<td>$base->date_maladie</td>
        <td>$base->remarque_antecedent</td>
