...
<td>
<p class="Style123" ><h2>Rechercher de vaccin(s)</h2>
<img src="mes_img/anl.png" width="300" height="300" />
</p></center> 

<form method="post" action="rech_vaccin.php" class="margin-left:200px;">
<span class="Style18">
<u>Chercher par :</u>
</span>
  <select name="type">
  <option value="id_analyse">id_inj</option>
    <option value="	nom_analyse">nom_vaccin</option>
...
$type = addslashes ($_POST['type']);
	if ($type="nom_vaccin")
	{
	$retour = mysql_query("SELECT * FROM injection WHERE nom_vaccin='$valeur' ORDER BY id_inj ASC");
	
	}
	elseif ($type="id_inj")
	{
	$retour = mysql_query("SELECT * FROM injection WHERE id_inj='" . $_POST['id_inj'] . "' ORDER BY id_inj ASC");
	}
?>
<p><center>
...
?>
  <tr>
    ...
    <td><?php echo stripslashes($donnees['id_inj']); ?></td>
    <td><?php echo stripslashes($donnees['nom_vaccin']); ?></td>
    <td><?php echo stripslashes($donnees['date_inj']); ?></td>
	<td><?php echo stripslashes($donnees['date_rappel']); ?></td>
  </tr>
  <?php
