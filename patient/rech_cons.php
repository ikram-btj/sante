...
<table border="0" cellspacing="0" cellpadding="0" width="600" style="    margin-left: 550px;
"> 
<tr> <td class="bodyText">
<table><tr><td width="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /></td>
<td>
<p class="Style123" >
<img src="mes_img/cnsl.jpg" width="300" height="300" />
Recherche de consultation(s)</p></center> 

<form method="post" action="rech_cons.php" class="margin-left:200px;">
<span class="Style18">
<u>Chercher par :</u>
</span>
  <select name="type">
  <option value="id_cons1">id_cons1</option>
    <option value="	date_cons">date_cons</option>
...
$type = addslashes ($_POST['type']);
	if ($type="date_cons")
	{
	$retour = mysql_query("SELECT * FROM consultation1 WHERE date_cons='$valeur' ORDER BY id_cons1 ASC");
	
	}
	elseif ($type="id_cons1")
	{
	$retour = mysql_query("SELECT * FROM consultation1 WHERE id_cons1='" . $_POST['id_cons1'] . "' ORDER BY id_cons1 ASC");
	}
?>
<p><center>
<table class="listVaccin table table-striped"  cellpadding="15"style="width: 130%;">
  <tbody>
    <tr>
      <td>id consultation</b></td>
      <td>date consultation</b></td>
      <td>medicament</b></td>
...
?>
  <tr>
    ...
    <td><?php echo stripslashes($donnees['id_cons1']); ?></td>
    <td><?php echo stripslashes($donnees['date_cons']); ?></td>
    <td><?php echo stripslashes($donnees['medicament']); ?></td>
  </tr>
  <?php
