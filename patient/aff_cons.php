...
//while ($champ = mysql_fetch_object($ligne) )
 ...
 $bd = mysql_query("SELECT  date_cons,medicament,commentaire_cons1 FROM consultation1 where id_p = '$id_p'  ") ;
while($base = mysql_fetch_object($bd)){
 echo "
      ...
      <tr>
        <td>$base->date_cons</td>
		<td>$base->medicament</td>
		<td>$base->commentaire_cons1</td>
