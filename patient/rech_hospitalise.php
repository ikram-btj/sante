...
<table border="0" cellspacing="0" cellpadding="0" width="600" style="    margin-left: 300px;
"> 
<tr> <td class="bodyText">
<table><tr><td width="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /></td>
<td>
<p class="Style123" ><h2>Recherche de hospitalisation(s)</h2>
<img src="mes_img/11.jpg" width="300" height="300" />
</p></center> 

<form method="post" action="rech_hospitalise.php" class="margin-left:400px;">
<span class="Style18">
<u>Chercher par :</u>
</span>
  
    <select name="type">
	<option value="date_intr">date_hosp</option>
...
$type = addslashes ($_POST['type']);
	if ($type="date_hosp")
	{
	$retour = mysql_query("SELECT * FROM hospitalise WHERE id_p='$id_p' and date_hosp='$valeur' ORDER BY id_hosp ASC");
	
	}
	
?>
<p><center>
<table class="listVaccin table table-striped"  cellpadding="15"style="width:300%;">
  <tbody>
    <tr>
	<td>service</b></td>
     <td>motif_hosp</b></td> 
...
?>
  <tr>
    ...
    <td><?php echo stripslashes($donnees['service']); ?></td>
	<td><?php echo stripslashes($donnees['motif_hosp']); ?></td>
	<td><?php echo stripslashes($donnees['duree_hosp']); ?></td>
  </tr>
  <?php
