			...
			<header>
				...
				<nav>
					<ul id="menu">
						...
						<li><a href="connexion/index.php"><span></span>Connection </a></li>
												<li><a href="admin/admin_dashboard.php"><span>admin</span></a></li>

						<li><a href="information/menu_info.php"><span>Information</span></a></li>
